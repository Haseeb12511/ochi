...
function Footer() {
  return (
    <div className='flex gap-5 w-full h-screen p-10'>
        ...
        <div className='w-1/2'>
            <h1 className='text-[6vw] font-semibold tracking-tighter leading-none'>
            PRESENTATIONS
            </h1>
            ...
            <div className='dets mt-16'>
                ...
                <a className='block text-xl font-light mt-5' href="#">30 Chukarina St</a>
                <a className='block text-xl font-light' href="#">Lviv, Ukraine</a>
                <a className='block text-xl font-light mt-5' href="#">haseebhussain1251@gmail.com</a>
            </div>
        </div>
    </div>
  )
